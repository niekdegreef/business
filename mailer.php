...
<a class="homelink" href="/"><img src="business-styles/images/home.jpg" width="200" alt=""></a>
    ...
    <div id="secondary" class=" secondary widget-area" role="complementary">
        ...
        <aside class="widget video_showcase group">
            <h2 class="widget-title">Latest demo</h2>
            <ul>
                <li>
                    <figure>
...
<!--             <img src="../images/logo.png" alt="">
 -->            <div class="quick-menu">
        ...
        <div class="site-info" >
            <span>
                This is an example of a <a href="http://beyerdegreef.com">Beyer de Greef</a> e-mail newsletter template, for demo purposes only.
           </span>
        </div>
