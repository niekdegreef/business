...
<div id="top" class="sg-header sg-container">
  <h1 class="sg-logo">Business template <span>styles</span></h1>
...
<h1><a href="/boilerplate">boilerplate</a></h1>
...
<div class="sg-body sg-container">
  <div class="sg-info">               
    ...
    <div class="sg-font-stacks sg-section">
      ...
      <p class="sg-font sg-font-primary heading">Headings: "tablet-gothic-semi-condensed", sans-serif;</p>
      <p class="sg-font sg-font-secondary bodytext">Body text: "calluna", serif;</p>
      <div class="sg-markup-controls"><a class="sg-btn--top" href="#top">Back to Top</a></div>
    </div><!--/.sg-font-stacks-->
  </div><!--/.sg-info-->    
